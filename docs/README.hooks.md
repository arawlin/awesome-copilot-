...
| [Prettier Format](../hooks/prettier-format/README.md) | Automatically formats modified files using Prettier when a session ends | sessionEnd | `format.sh`<br />`hooks.json` |
